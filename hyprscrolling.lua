...
hl.bind(mainMod .. " + ALT + L", hl.dsp.window.move({ into_or_create_group, direction = "r" }))
hl.bind(mainMod .. " + ALT + H", hl.dsp.window.move({ into_or_create_group, direction = "l" }))
hl.bind(mainMod .. " + ALT + K", hl.dsp.window.move({ into_or_create_group, direction = "u" }))
hl.bind(mainMod .. " + ALT + J", hl.dsp.window.move({ into_or_create_group, direction = "d" }))
hl.bind(mainMod .. " + SHIFT + ALT + L", hl.dsp.window.move({ out_of_group, direction = "r" }))
hl.bind(mainMod .. " + SHIFT + ALT + H", hl.dsp.window.move({ out_of_group, direction = "l" }))
hl.bind(mainMod .. " + SHIFT + ALT + K", hl.dsp.window.move({ out_of_group, direction = "u" }))
hl.bind(mainMod .. " + SHIFT + ALT + J", hl.dsp.window.move({ out_of_group, direction = "d" }))
