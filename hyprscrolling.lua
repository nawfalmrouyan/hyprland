...
hl.bind(main .. " + SHIFT + L", hl.dsp.window.move({ direction = "r" }))
hl.bind(main .. " + SHIFT + H", hl.dsp.window.move({ direction = "l" }))
hl.bind(main .. " + SHIFT + K", hl.dsp.window.move({ direction = "u" }))
hl.bind(main .. " + SHIFT + J", hl.dsp.window.move({ direction = "d" }))
...
hl.bind(main .. " + SHIFT + ALT + L", hl.dsp.window.move({ out_of_group, "r" }))
hl.bind(main .. " + SHIFT + ALT + H", hl.dsp.window.move({ out_of_group, "l" }))
hl.bind(main .. " + SHIFT + ALT + K", hl.dsp.window.move({ out_of_group, "u" }))
hl.bind(main .. " + SHIFT + ALT + J", hl.dsp.window.move({ out_of_group, "d" }))
