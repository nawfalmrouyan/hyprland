...
hl.bind(
	mainMod .. " + G",
	hl.dsp.exec_cmd(
		"if [ $(hyprctl activewindow | rg 'grouped:' | rg -v 'Window' | tr -dc ',' | wc -c) -gt '0' ]; then hyprctl dispatch 'hl.dsp.group.lock_active({ action = \"toggle\" })'; else hyprctl dispatch 'hl.dsp.group.toggle()'; fi"
	),
	{ description = "Toggle group / Lock group" }
)
hl.bind(mainMod .. " + Tab", hl.dsp.group.next(), { description = "Cycle windows in a group" })
